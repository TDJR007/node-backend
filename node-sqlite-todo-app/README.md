# BACKEND Application - Node.JS Express.JS & Node:SQLite
...
By default, the app runs on port 3000. If you want to run it on **localhost:3000**, you can modify the `.env` file:
...
```bash
git clone https://github.com/TDJR007/node-backend.git
cd node-sqlite-todo-app
```
...
PORT=3000 # Or change to 5000 if preferred
```
